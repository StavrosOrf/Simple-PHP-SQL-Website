...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //checking if Student table is created(just for the first time)
      ...
      $monbileNumber = mysqli_real_escape_string($conn,$_POST['MobileNumber']);
      $date = mysqli_real_escape_string($conn,$_POST['Date']);

      $sql = "INSERT INTO `Students` (`NAME`, `SURNAME`, `FATHERNAME`,`GRADE`,`MOBILENUMBER`,`BIRTHDAY`)
      VALUES ('$name','$surname','$fathername','$grade','$monbileNumber','$date')";
...
<div class="login-form">
    <form action = "" method = "post">
		...
		<div class="form-group">
            <input  type="text" class="form-control" name = "Fathername" placeholder="Fathername" required="required">
        </div>
        <div class="form-group">
            <input name="Grade" type="number" class="form-control" placeholder="Grade" required="required">
        </div>
        <div class="form-group">
        ...
        <div style = "font-size:20px; color:green; margin-top:10px;text-align: center;"><?php echo $msg; ?></div>
